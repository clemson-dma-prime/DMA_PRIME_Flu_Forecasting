...
MUSC_Weekly_Influenza_Region <- read_csv(
   '/Users/tanvirahammed/Library/CloudStorage/Box-Box/BoxPHI-PHMR Projects/Data/MUSC/Infectious Disease EHR/Weekly Data/COVID-19/06_26_2025/MUSC_Weekly_COVID-19_Region_06_26_2025.csv'
   )

## --- Import Prisma Health Weekly Influenza Data ---
Prisma_Weekly_Influenza_Region <- read_csv(
   '/Users/tanvirahammed/Library/CloudStorage/Box-Box/BoxPHI-PHMR Projects/Data/Prisma Health/Infectious Disease EHR/Weekly Data/COVID-19/06_26_2025/Prisma_Health_COVID_Region.csv'
   )
...
#RFA -------------
hosp_data_rfa <- read_csv('/Users/tanvirahammed/Library/CloudStorage/Box-Box/BoxPHI-PHMR Projects/Data/SC Health Records/RFA/Years 2019-2023/Clean Data/Archived/data_covid_filtered.csv',
...
ggplot(df_combined, aes(x = Week)) +
   ...
   facet_wrap(~ Region, scales = "free") +
   labs(
      title = "COVID-19: Observed vs. Distributed Encounters Over Weeks",
      x = "Week",
      y = "Count",
      color = ""
   ) +
