...
MUSC_Weekly_Influenza_County <- read_csv(
   '/Users/tanvirahammed/Library/CloudStorage/Box-Box/BoxPHI-PHMR Projects/Data/MUSC/Infectious Disease EHR/Weekly Data/Influenza/06_26_2025/MUSC_Weekly_Influenza_County_06_26_2025.csv'
)

## --- Import Prisma Health Weekly Influenza Data ---
Prisma_Weekly_Influenza_County <- read_csv(
   "/Users/tanvirahammed/Library/CloudStorage/Box-Box/BoxPHI-PHMR Projects/Data/Prisma Health/Infectious Disease EHR/Weekly Data/Influenza/06_26_2025/Prisma_Health_Influenza_County.csv"
)
...
ggplot(df_combined, aes(x = Week)) +
   ...
   labs(
      title = "Influenza: Observed, Smoothed Observed, and Distributed Encounters Over Weeks",
      x = "Week",
      y = "Count",
      color = ""
   ) +
