...
MUSC_Weekly_Influenza_County <- read_csv(
   '/Users/tanvirahammed/Library/CloudStorage/Box-Box/BoxPHI-PHMR Projects/Data/MUSC/Infectious Disease EHR/Weekly Data/COVID-19/06_26_2025/MUSC_Weekly_COVID-19_County_06_26_2025.csv'
)

## --- Import Prisma Health Weekly Influenza Data ---
Prisma_Weekly_Influenza_County <- read_csv(
   '/Users/tanvirahammed/Library/CloudStorage/Box-Box/BoxPHI-PHMR Projects/Data/Prisma Health/Infectious Disease EHR/Weekly Data/COVID-19/06_26_2025/Prisma_Health_COVID_County.csv'
)
...
counties_to_keep <- county_counts_2023[N > 500, County]
